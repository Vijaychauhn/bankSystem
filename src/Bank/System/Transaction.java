...
public class Transaction extends JFrame implements ActionListener{
    JButton deposit, withdrawal,fastcash, ministatement, pinchange, balancequiry, exit;
    String pinNumber;
    Transaction(String pinNumber){
        ...
        JLabel text = new JLabel("Please select your your Transaction");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==exit){
            ...
            setVisible(false);
            new Balanceequery(pinNumber).setVisible(true);
        }
